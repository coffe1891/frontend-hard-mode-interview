...
2020年开年的一次新冠疫情，导致公司彻底倒闭，我也失业了（哎呀，人算不如天算）。现在和很多程序员朋友一样有了新的挑战：打算重新找一份工作。我计划入职一线互联网公司做感兴趣的前端\(Front-End\)工作。嗯，因为年龄较大，要和年轻人抢饭碗其实是很难的，很多互联网公司的雇主似乎不太接受，面试之旅已然进入Hard模式。面对如此逆境，我希望避免拼体力（加班刷夜怎么也拼不过年轻人了），希望通过用扎实的技术功底和丰富的工作实战经验来打动雇主以达成目标。
