...
因此做了这个内参，把前端知识和前端面试要点梳理一遍，作为自己求职的复习/进阶内参。现在分享出来，用心写上点评，希望对你有用；同时，我会假设你已经有了差不多3年的前端工作经验，这样你阅读内参的时候体验会更加愉快。如果我最终能达成入职一线互联网公司的目标，更年轻、更健康和更聪明的你们只会比我做的更好。加油吧，弟弟妹妹们！
