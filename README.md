...
在我复习/学习期间，查阅了国外和国内大量的一手文档资料，发现原始的资料相对少，即使有原始的资料也是论文式的，对英语阅读能力有非常大的挑战；而国内的资料大多数有错漏、不完整，而且翻译问题非常大，描述不严谨，知识点分散零碎不系统……各种原因，对自己的学习过程造成了很大的困扰。感同身后之后，因此整理、编写了本书（嗯，目前还正在写，许多章节等我们去“点亮”😸），把前端知识和前端面试要点梳理一遍，作为自己前端求职的复习/进阶内参。现在分享出来，每章开头用心地以写上本章导读，方便阅读前参考。
