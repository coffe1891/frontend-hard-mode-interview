...
然后有前端朋友可能会吐槽：“前端知识已经爆炸，今天这个框架明天那个库的，天天有新玩意儿，我实在学不动了！”是的，前端知识早已大爆炸，新东西层出不穷，如果只是靠蛮力一样一样地去学习，那么连笔者我也学不动了😂 。怎么办呢？别慌，其实前端学习是有窍门的。本书归纳了前端的核心知识点，日拱一卒地坚持学习，系统地掌握这些知识点之后，相信很快你也能和我一样可以做到以不变应万变，以小变应大变，并对新的前端知识很快领悟、吃透！
...
1. 一线互联网公司面试前的准备
   ...
   * [准备一份好的简历](0/0.1.4.md) _`updating…`_
...
1. 面试时高频率出现的算法
   ...
   * [实战：阿里巴巴前端面试算法题](2/2.1.7.md) _`updating…`_
2. 其他经典算法
...
2. 函数式编程
   ...
   * [Pointfree无参数风格编程](5/5.2.3.md) _`updating…`_
3. 响应式编程
   * [什么是响应式编程？](5/5.3.1.md)
   * RxJS
...
2. 浅谈软件工程：MVC、MVP、MVVM
   * [MVC的前世今生](7/7.2.1.md) _`updating…`_
   * MVP又是什么？
   * 有了MVC和MVP，为什么还要MVVM？
