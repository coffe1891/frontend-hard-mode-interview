...
在南方蛰伏2年后，疫情导致失业。现在很多人一样有了新的挑战：重新找一份工作。我计划入职一线互联网公司做感兴趣的前端\(Front-End\)工作。因为年龄大，嗯，其实这是很难的，很多互联网公司的雇主似乎不太接受这样的，面试之旅已然进入Hard模式。面对如此逆境，我决定勤学苦练，用扎实的技术功底和优秀的面试表现打动雇主以达成目标。
